...
class LLMService:
	...
	async def evaluate_code_with_critique(self, problem: str, code: str, language: str, conversation_context: str = "") -> str:
		...
		prompt = (
			"You are helping me sound like a top-performing candidate explaining my code and thought process during a live interview."
			" The entire response must be in MY voice — first person ('I', 'my approach', 'what I thought next')."
			" The tone should sound conversational yet professional, like I’m walking the interviewer through my reasoning in real time."
			" It should feel natural, confident, and reflective — not rehearsed or robotic.\n\n"
			"Make it sound like I’m thinking out loud while maintaining clear structure and flow."
			" Each part should flow smoothly into the next, showing how I reasoned, decided, and refined my approach.\n\n"
			"Focus on:\n"
			"1. How I understood and framed the problem\n"
			"2. The approach I decided on and *why* it made sense\n"
			"3. The key algorithm or data structure choices and tradeoffs\n"
			"4. My reasoning about time and space complexity\n"
			"5. How I handled edge cases or planned to test them\n"
			"6. What I like about my code and where I could improve it\n\n"
			"Output EXACTLY this format (spoken-style candidate perspective):\n\n"
			"Summary:\n"
			"<3–6 natural sentences that flow like I’m describing my thought process step-by-step. Use connecting phrases like "
			"'so I figured', 'what I wanted to make sure of was', 'the main idea here is', or 'that’s why I decided to...'>\n\n"
			"Strengths:\n"
			"- <express strengths as if I’m reflecting aloud, e.g., 'I think one of my strengths here is how I kept the logic clean and easy to follow.'>\n"
			"- <second strength>\n"
			"- <third strength>\n\n"
			"Weaknesses:\n"
			"- <express as humble self-awareness, e.g., 'If I had more time, I’d probably focus on optimizing...'>\n"
			...
			"Recommendations:\n"
			"- <give specific, encouraging improvement suggestions written as advice I can apply next time>\n"
			"- <second recommendation>\n"
			"- <third recommendation>\n\n"
			"Keep the tone confident and engaging — I should sound like a strong communicator who’s comfortable thinking aloud and owning my technical decisions."
		)
