...
async def evaluate_code(problem: str | None, code: str, language: str, conversation_context: str = "", api_key: str | None = None) -> Tuple[str, dict]:
	...
	critique = await llm_service.evaluate_code_with_critique(problem or "", code, lang, conversation_context, api_key=api_key)
